...
$sql=mysqli_query($con,"insert into hod (school,department,fullname,dob,phone,address,email,password) values('$school','$department','$fullname','$dob','$phone','$address','$email','$password')");
$_SESSION['msg']="New HOD ADDED !!";
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Opp!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<label class="control-label" for="basicinput">School</label>
<div class="controls">
<select name="school" class="span8 tip" required>
<option value="">Select School</option> 
<option value="School_of_Art"> School of Art</option>
<option value="school_of_sceince">School of Science</option>  
</select>
</div>
</div>
...
<div class="controls">
<input type="text" placeholder="Enter HOD Department"  name="department" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="date" placeholder="Enter HOD Date of Birth"  name="dob" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Phone NO.</label>
<div class="controls">
<input type="text" placeholder="Enter Mobile NO"  name="phone" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="text" placeholder="Enter Email Address"  name="email" class="span8 tip" required>
</div>
</div>
<div class="control-group">
