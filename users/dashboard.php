...
$rt = mysqli_query($con,"SELECT * FROM tblcomplaints where userEmail='".$_SESSION['login']."' and status is null");
...
<a href="complaint-history.php">
                  ...
                  <span class="li_news"></span>
                    <?php 
  $status="in Process";                   
$rt = mysqli_query($con,"SELECT * FROM tblcomplaints where userEmail='".$_SESSION['login']."' and  status='$status'");
$num1 = mysqli_num_rows($rt);
{?>
                  <h3><?php echo htmlentities($num1);?></h3>
                        </div>
