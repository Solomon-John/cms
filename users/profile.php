...
<label class="col-sm-2 col-sm-2 control-label">Department</label>
 <div class="col-sm-4">
<input type="text" name="contactno" required="required" value="<?php echo htmlentities($row['department']);?>" class="form-control" readonly>
</div>
...
<div class="col-sm-4">
<input type="text" name="school" maxlength="6" required="required" value="<?php echo htmlentities($row['school']);?>" class="form-control" readonly >
</div>
