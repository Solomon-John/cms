...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,userEmail,password,school,department,contactNo,status) values('$fullname','$email','$password',''$school','$department',$contactno','$status')");
...
<div class="">
<select name="school" id="category" class="form-control" onChange="getCat(this.value);" required="">
